...
class Twig_Environment_Cadenza extends Twig_Environment {
	...
	function __construct() {
		...
		$this->addGlobal('ASSETS_CSS_LANDING_PAGE', Core::cadenzaWebPath('assets/css/landing-page.css'));
		$this->addGlobal('ASSETS_CSS_FAST_CDN', Core::cadenzaWebPath('assets/css/fastcdn.css'));
		$this->addGlobal('ASSETS_CSS_FAST_CDN_STYLE', Core::cadenzaWebPath('assets/css/fastcdn-style.css'));
		...
		$this->addGlobal('CADENZA_LANDING_PAGE_JS', Core::cadenzaWebPath('js/landing-page.js'));
