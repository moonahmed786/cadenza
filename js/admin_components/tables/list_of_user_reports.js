...
_.admin_components.tables.list_of_user_reports = {};

_.admin_components.tables.list_of_user_reports.tableId = 'id_table_list_of_user_reports';

_.admin_components.tables.list_of_user_reports.init = function() {
	...
	$('#'+adminComponentId+' .mark-resolved').click(function(e) {
		...
		if (!_.page.isAjaxInProgress) {
			_.page.actionPost('markAsResolvedFromUserReports', data, function(response) {
...
_.admin_components.tables.list_of_user_reports.initWidgets = function() {
	_.widgets.sortable_label.init();
};

_.admin_components.tables.list_of_user_reports.refreshAdminComponent = function(html) {
