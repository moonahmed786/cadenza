...
_.admin_components.tables.list_of_user_flags = {};

_.admin_components.tables.list_of_user_flags.tableId = 'id_table_list_of_user_flags';

_.admin_components.tables.list_of_user_flags.init = function() {
	...
	$('#'+adminComponentId+' .mark-resolved').click(function(e) {
		...
		if (!_.page.isAjaxInProgress) {
			_.page.actionPost('markAsResolvedFromUserFlags', data, function(response) {
...
_.admin_components.tables.list_of_user_flags.initWidgets = function() {
	_.widgets.sortable_label.init();
};

_.admin_components.tables.list_of_user_flags.refreshAdminComponent = function(html) {
