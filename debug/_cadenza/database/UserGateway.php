...
class UserGateway extends Tdg {
	...
	static function insert($email_normalized, $g_email, $g_name, $g_given_name, $g_family_name, $g_picture, $g_refresh_token, $user_type, $last_login, $status, $status_date, $created_date) {
